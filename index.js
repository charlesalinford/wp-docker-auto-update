...
execs('docker exec -t -i ' + container_id + ' /bin/bash -c "cd /var/www/vhosts/' + site_id + '/public && wp core update --allow-root"', { stdio:'inherit' });

//Check for plugin updates
console.log('Step 2: Checking for plugin updates...'.yellow);
execs('docker exec -t -i ' + container_id + ' /bin/bash -c "cd /var/www/vhosts/' + site_id + '/public && wp plugin update --all --allow-root"', { stdio:'inherit' });
